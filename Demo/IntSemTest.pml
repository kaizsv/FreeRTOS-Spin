...
::  vTaskSuspend(_PID, NULL_byte, local_var1, local_var2);
    ...
    xSemaphoreGive(xMasterSlaveMutex, local_xReturn, local_var1, local_var2, _PID);
    AWAIT(_PID, assert(local_xReturn == true); local_xReturn = false);
od
}
...
inline prvTakeAndGiveInTheSameOrder(_id, xReturn, temp_bit, temp_var1, temp_var2)
{
    ...
    xSemaphoreGive(xISRMutex, xReturn, temp_var1, temp_var2, _id);
    AWAIT(_id,
...
init
{
    ...
    xSemaphoreCreateMutex(xISRMutex, 0, local_var1, local_var2, EP);
    skip;
    ...
    xSemaphoreCreateMutex(xMasterSlaveMutex, 2, local_var1, local_var2, EP);
    skip;
