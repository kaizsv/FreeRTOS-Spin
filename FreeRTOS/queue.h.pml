...
#define xQueueSendToFront_NB(xQueue, pvItemToQueue, xTicksToWait, xReturn, temp_bool, temp_xIsTimeOut, temp_var, temp_var2, _id) \
    xQueueGenericSend_NB(xQueue, pvItemToQueue, xTicksToWait, queueSEND_TO_FRONT, xReturn, temp_bool, temp_xIsTimeOut, temp_var, temp_var2, _id)
...
#define xQueueSendToBack_NB(xQueue, pvItemToQueue, xTicksToWait, xReturn, temp_bool, temp_xIsTimeOut, temp_var, temp_var2, _id) \
    xQueueGenericSend_NB(xQueue, pvItemToQueue, xTicksToWait, queueSEND_TO_BACK, xReturn, temp_bool, temp_xIsTimeOut, temp_var, temp_var2, _id)
...
#define xQueueOverwrite(xQueue, pvItemToQueue, xReturn, temp_bool, temp_xIsTimeOut, temp_var, temp_var2, _id) \
    xQueueGenericSend_NB(xQueue, pvItemToQueue, 0, queueOVERWRITE, xReturn, temp_bool, temp_xIsTimeOut, temp_var, temp_var2, _id)
